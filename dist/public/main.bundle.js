...
var ContentComponent = (function () {
    function ContentComponent(route, CourseService) {
        this.route = route;
        this.CourseService = CourseService;
        this.dividerRatio = 6;
    }
    ContentComponent.prototype.ngOnInit = function () {
        ...
        this.route.params.subscribe(function (params) {
            if (typeof (params['id']) === 'string') {
                _this.CourseService.getContent(params['id']).subscribe(function (res) {
                    _this.course = res;
                    console.log(_this.course);
                });
            }
...
var DashboardComponent = (function () {
    ...
    DashboardComponent.prototype.purchase = function (i) {
        ...
        this.CourseService.addUser(payload).subscribe(function (res) {
            _this.courses[i].users.push(payload.userId);
