...
var DashboardComponent = (function () {
    ...
    DashboardComponent.prototype.cb = function (token) {
        console.log(self);
        console.log(this);
        this.CourseService.payment(token).subscribe(function (res) {
            console.log(res);
        });
    };
        ...
        if (this.AuthService.loggedIn) {
            var handler = window.StripeCheckout.configure({
                ...
                token: function (token) {
                    token.price = Number(_this.courses[i].price) * 100;
                    token.currency = 'usd';
