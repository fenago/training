...
/***/ "../../../../../client/app/admin/analytics/analytics.component.css":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "../../../../../client/app/admin/analytics/analytics.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var AnalyticsComponent = (function () {
    function AnalyticsComponent(router) {
        this.router = router;
    }
    AnalyticsComponent.prototype.ngOnInit = function () {
        ...
        gapi.analytics.ready(function () {
            ...
            var CLIENT_ID = '309132701992-nb3o0gi5uc4dq8e5dcpaq7opif3di2cn.apps.googleusercontent.com';
    ...
    AnalyticsComponent.prototype.initGA = function () {
        // Step 3: Authorize the user.
        var CLIENT_ID = '309132701992-nb3o0gi5uc4dq8e5dcpaq7opif3di2cn.apps.googleusercontent.com';
        // Step 4: Create the view selector.
        var viewSelector = new gapi.analytics.ViewSelector({
    ...
    AnalyticsComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            ...
            template: __webpack_require__("../../../../../client/app/admin/analytics/analytics.component.html"),
            styles: [__webpack_require__("../../../../../client/app/admin/analytics/analytics.component.css")]
        }),
...
var AddContentComponent = (function () {
    ...
    AddContentComponent.prototype.valuechange = function ($event) {
        console.log($event);
    };
    AddContentComponent.prototype.ngOnInit = function () {
        ...
        this.resourcesUploader = new __WEBPACK_IMPORTED_MODULE_3_ng2_file_upload__["FileUploader"](uploaderOptions2);
        ...
        this.resourcesUploader.onBuildItemForm = function (fileItem, form) {
            // Add Cloudinary's unsigned upload preset to the upload form
            form.append('upload_preset', _this.cloudinary.config().upload_preset);
            // Add file to upload
            form.append('file', fileItem);
        ...
        this.uploader.onCompleteItem = function (item, response, status, headers) {
            ...
            console.log(_this.cloudResponse);
        ...
        this.resourcesUploader.onCompleteItem = function (item, response, status, headers) {
            var file = JSON.parse(response);
            _this.course.content.chapters[_this.chapterIndex].resources.push({ name: file.original_filename, link: file.url });
        };
        this.options = {
            height: 300,
            fileUpload: false,
    ...
    AddContentComponent.prototype.selectResources = function (i) {
        this.chapterIndex = i;
    };
    ...
    AddContentComponent.prototype.removeResource = function (indices) {
...
var AddCourseComponent = (function () {
    function AddCourseComponent(CourseService, toast, route, router, cloudinary) {
        this.CourseService = CourseService;
        this.toast = toast;
        this.route = route;
        this.router = router;
    ...
    AddCourseComponent.prototype.generateCoupon = function () {
    ...
    AddCourseComponent.prototype.deleteCoupon = function (i) {
        this.course.coupons.splice(i, 1);
    };
    AddCourseComponent.prototype.refreshCouponId = function (i) {
        console.log(i);
        this.course.coupons[i].id = this.makeid();
    };
    AddCourseComponent.prototype.makeid = function () {
        var text = '';
    ...
    AddCourseComponent.prototype.delete = function (course) {
        var _this = this;
        this.isLoading = true;
        this.CourseService.deletecourse(course).subscribe(function (res) {
            _this.isLoading = false;
            _this.router.navigateByUrl('/dashboard');
            _this.toast.setMessage('course deleted!', 'success');
        });
    };
...
module.exports = "<div class=\"content\" *ngIf=\"isLoading\">\r\n  <div class=\"loader\" style=\"margin-top:20%\"></div>\r\n</div>\r\n<div class=\"content\" *ngIf=\"!isLoading\">\r\n  <app-toast [message]=\"toast.message\"></app-toast>\r\n  <nav class=\"navbar navbar-dark\" mat-tab-nav-bar>\r\n    <a routerLink=\"/publish/new\" class=\"nav-item nav-link\" mat-tab-link routerLinkActive=\"active\">\r\n      <h5>\r\n        <i class=\"fa fa-plus\"></i> Add</h5>\r\n    </a>\r\n    <a routerLink=\"/publish/unPublishedList\" class=\"nav-item nav-link\" mat-tab-link routerLinkActive=\"active\">\r\n      <h5>\r\n        <i class=\"fa fa-list\"></i> un-published list</h5>\r\n    </a>\r\n    <a (click)=\"showResources()\" class=\"nav-item nav-link\" mat-tab-link routerLinkActive=\"active\">\r\n      <h5>\r\n        <i class=\"fa fa-link\"></i> Resources</h5>\r\n    </a>\r\n  </nav>\r\n  <div class=\"buffer20\" *ngIf=\"resourcesFlag\"></div>\r\n  <ul *ngIf=\"resourcesFlag\">\r\n    <li>\r\n      <a style=\"color:blue\" href=\"https://screencast-o-matic.com/screen_recorder\">https://screencast-o-matic.com/screen_recorder</a>\r\n    </li>\r\n    <li>\r\n      <a style=\"color:blue\" href=\"https://screencast-capture.en.softonic.com/\">https://screencast-capture.en.softonic.com/</a>\r\n    </li>\r\n  </ul>\r\n  <router-outlet></router-outlet>\r\n</div>\r\n"
...
var PublishComponent = (function () {
    ...
    PublishComponent.prototype.showResources = function () {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_35__admin_analytics_analytics_component__ = __webpack_require__("../../../../../client/app/admin/analytics/analytics.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_36_videogular2_core__ = __webpack_require__("../../../../videogular2/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_36_videogular2_core___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_36_videogular2_core__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_37_videogular2_controls__ = __webpack_require__("../../../../videogular2/controls.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_37_videogular2_controls___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_37_videogular2_controls__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_38_videogular2_overlay_play__ = __webpack_require__("../../../../videogular2/overlay-play.js");
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_36_videogular2_core__["VgCoreModule"],
                __WEBPACK_IMPORTED_MODULE_37_videogular2_controls__["VgControlsModule"],
                __WEBPACK_IMPORTED_MODULE_38_videogular2_overlay_play__["VgOverlayPlayModule"],
                __WEBPACK_IMPORTED_MODULE_39_videogular2_buffering__["VgBufferingModule"]
            ],
            providers: [
...
var ContentComponent = (function () {
    ...
    ContentComponent.prototype.getData = function () {
        ...
        if (typeof (this.courseId) === 'string') {
            this.CourseService.getContent(this.courseId).subscribe(function (res) {
                _this.course = res;
                if (_this.preview) {
                    for (var i = 0; i < _this.course.content.chapters.length; i++) {
                        if (!_this.course.content.chapters[i].preview) {
                            _this.course.content.chapters.splice(i, 1);
                        }
                    }
                }
            });
    ...
    ContentComponent.prototype.canActivate = function () {
        ...
        this.route.params.subscribe(function (params) {
            ...
            _this.preview = Boolean(params['preview']) ? true : false;
...
var DashboardComponent = (function () {
    ...
    DashboardComponent.prototype.useCoupon = function (i) {
        this.courses[i]['useCouponFlag'] = !this.courses[i]['useCouponFlag'];
        console.log(this.course[i]);
    };
    DashboardComponent.prototype.verifyCoupon = function (i) {
        var _this = this;
        console.log(i);
        ...
        if (this.courses[i].coupons) {
            var _loop_1 = function (j) {
                if (this_1.courses[i]['coupon'] === this_1.courses[i].coupons[j].id) {
                    setTimeout(function () {
                        _this.toast.setMessage('coupon approved', 'success');
                        _this.courses[i]['couponFlag'] = true;
                        var amount = _this.courses[i].coupons[j].amount;
                        _this.courses[i]['couponAmount'] = amount;
                        if (amount === 100) {
                            _this.courses[i].price = 0;
                        }
            ...
            var this_1 = this;
            for (var j = 0; j < this.courses[i].coupons.length; j++) {
                _loop_1(j);
            }
        }
        setTimeout(function () {
            if (_this.couponLoading) {
                _this.toast.setMessage('invalid coupon', 'warning');
                _this.couponLoading = false;
            }
        }, 2000);
    };
...
var routes = [
    ...
    { path: 'content/:id/:preview', component: __WEBPACK_IMPORTED_MODULE_11__content_content_component__["a" /* ContentComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_22__services_auth_guard_login_service__["a" /* AuthGuardLogin */]] },
...
var courseService = (function () {
    ...
    courseService.prototype.verifyCoupon = function (data) {
        console.log('insert', data);
        return this.http.post(this.url + '/api/course/coupon', data);
    };
