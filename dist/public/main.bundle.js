            ...
            var _loop_1 = function (j) {
                if (this_1.courses[i]['coupon'] === this_1.courses[i].coupons[j].id) {
                    setTimeout(function () {
                        ...
                        _this.courses[i]['couponAmount'] = _this.courses[i].coupons[j].amount;
